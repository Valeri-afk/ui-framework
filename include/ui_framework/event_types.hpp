...
namespace ui
{
    ...
    struct MouseDownEvent : UIEvent
    {
        MousePosition position{};
        MouseButton button = MouseButton::Unknown;
    };

    struct MouseUpEvent : UIEvent
    {
        MousePosition position{};
        MouseButton button = MouseButton::Unknown;
    };

    struct MouseClickEvent : UIEvent
    {
        MousePosition position{};
        MouseButton button = MouseButton::Unknown;
    };

    struct MouseWheelEvent : UIEvent
    {
        MousePosition position{};
    ...
    struct MouseDragBeginEvent : UIEvent
    {
        bool dragging = false;
        MousePosition position{};
        LayoutSize delta{};
    ...
    struct MouseDragEndEvent : UIEvent
    {
        MousePosition position{};
        LayoutSize delta{};
    };

    struct KeyDownEvent : UIEvent
    {
        bool is_repeat = false;
        KeyCode key = KeyCode::UNKNOWN;
    };

    struct KeyUpEvent : UIEvent
    {
        bool is_repeat = false;
        KeyCode key = KeyCode::UNKNOWN;
    };
